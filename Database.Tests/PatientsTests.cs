...
namespace Database.Tests
{
    ...
    public class PatientsTests : SqlDatabaseTestClass
    {
        ...
        {
            Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction Database_PersistPatients_TestAction;
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PatientsTests));
            Microsoft.Data.Tools.Schema.Sql.UnitTesting.Conditions.ExecutionTimeCondition executionTimeCondition1;
            this.Database_PersistPatientsData = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestActions();
            Database_PersistPatients_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            ...
            // 
            this.Database_PersistPatientsData.PosttestAction = null;
            this.Database_PersistPatientsData.PretestAction = null;
            this.Database_PersistPatientsData.TestAction = Database_PersistPatients_TestAction;
            // 
        ...
        {
            SqlDatabaseTestActions testActions = this.Database_PersistPatientsData;
